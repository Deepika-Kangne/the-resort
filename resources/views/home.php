        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="custom-collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Menu</a>
                <ul class="dropdown-menu">
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Lunch</a>
                    <ul class="dropdown-menu">
                      <li><a href="index_mp_fullscreen_static.html">Veg</a></li>
                      <li><a href="index_mp_classic_static.html">Non-Veg</a></li>
                    </ul>
                  </li>
                </ul>
              </li>
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Stuff</a>
                <ul class="dropdown-menu" role="menu">
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Contact</a>
                <ul class="dropdown-menu" role="menu">
                  <li><a href="alerts-and-wells.html"><i class="fa fa-bolt"></i> Instagram</a></li>
                  <li><a href="buttons.html"><i class="fa fa-link fa-sm"></i> Facebook</a></li>
                </ul>
              </li>
            </ul>
          </div>
      ...
      <section class="home-section home-full-height bg-dark-30" id="home">
        <div class="hero-slider">
          <ul class="slides">
              ...
              <div class="titan-caption">
                <div class="caption-content">
                  <div class="font-alt mb-30 titan-title-size-1">
                    <video class="video-player" autoplay muted loop id="myVideo">
                        <source src="assets/Malshej.mp4" type="video/mp4">
                        Your browser does not support HTML5 video.
                    </video>
                  </div>
                  <div class="centered">
                  <div class="font-alt mb-30 titan-title-size-2"> Hello & welcome</div>
                  <div class="font-alt mb-40 titan-title-size-4">The Umbartha Resort</div><a class="section-scroll btn btn-border-w btn-round" href="#menu">Check Our Menu</a>
                  <div>
                </div>
              </div>
            </li>
            <li class="bg-dark-30 restaurant-page-header bg-dark" style="background-image:url(&quot;assets/images/img-2.jpeg&quot;);">
              <div class="titan-caption">
                <div class="caption-content">
            ...
            <li class="bg-dark-30 restaurant-page-header bg-dark" style="background-image:url(&quot;assets/images/img-3.jpeg&quot;);">
              <div class="titan-caption">
                <div class="caption-content">
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt">What we have</h2>
            ...
            <div class="row">
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="alt-features-item">
                  ...
                  <h3 class="alt-features-title font-alt">Legacy</h3>A wonderful serenity has taken possession of my entire soul like these sweet mornings.
                </div>
                <div class="alt-features-item">
                  <div class="alt-features-icon"><span class="icon-tools-2"></span></div>
                  <h3 class="alt-features-title font-alt">Luxurious Stay</h3>A wonderful serenity has taken possession of my entire soul like these sweet mornings.
                </div>
                <div class="alt-features-item">
                  <div class="alt-features-icon"><span class="icon-target"></span></div>
                  <h3 class="alt-features-title font-alt">Afforable</h3>A wonderful serenity has taken possession of my entire soul like these sweet mornings.
                </div>
                <div class="alt-features-item">
                  <div class="alt-features-icon"><span class="icon-tools"></span></div>
                  <h3 class="alt-features-title font-alt">Nature</h3>A wonderful serenity has taken possession of my entire soul like these sweet mornings.
                </div>
              </div>
              <div class="col-md-6 col-lg-6 hidden-xs hidden-sm">
                <div class="alt-services-image align-center"><img src="assets/images/door.jpeg" alt="Feature Image"></div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="alt-features-item">
